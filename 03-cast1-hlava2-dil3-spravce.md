...
Insolvenční správce je **centrální postavou insolvenčního řízení**. Spojuje v sobě dvě role:
- **procesní orgán** — kvazi-soudní subjekt s vlastními pravomocemi vůči dlužníkovi, věřitelům, třetím osobám, soudům i státním orgánům;
- **správce cizího majetku** — drží dispoziční oprávnění k majetkové podstatě (zejména po prohlášení konkursu, § 246), spravuje a zpeněžuje ji, vyplácí výnos věřitelům.

Pro postavení správce platí **dvoukolejná úprava**:
1. **IZ (§ 21 – § 45)** — postavení v rámci jednotlivého řízení (ustanovení, povinnosti, odpovědnost, odměna, odvolání).
2. **Zákon č. 312/2006 Sb., o insolvenčních správcích** — *status profesní* (kvalifikace, zkoušky, seznam, dohled, sankce, hostující správci atd.).

Tento komentář popisuje § 21 – § 45 IZ; pro otázky kvalifikace a profesního dozoru správce viz souběžný komentář k zákonu č. 312/2006 Sb.
