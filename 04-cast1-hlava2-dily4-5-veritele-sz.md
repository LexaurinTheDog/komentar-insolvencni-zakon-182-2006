...
## Díl 4 — Věřitelské orgány (§ 46 — § 68) a Díl 5 — Další procesní subjekty (§ 69 — § 70)

Věřitelské orgány jsou **kolektivní výraz vůle věřitelů** v insolvenčním řízení. Bez nich by věřitelé nemohli kromě individuálního přihlášení pohledávky nijak ovlivnit průběh řízení — rozhodoval by jen soud a správce. Smyslem věřitelských orgánů je tedy:

- **demokratizace** rozhodování (volba mezi konkursem a reorganizací, schválení reorganizačního plánu, oddlužení atd.),
- **kontrola** správce (možnost odvolání, schvalování významných úkonů),
- **artikulace společného zájmu** věřitelů (§ 2 písm. j),
- **konsensus mezi heterogenními skupinami** (zajištění × nezajištění, velcí × malí, koncern × outsideri).

**Tři typy věřitelských orgánů:**

| Orgán | Kdo, kdy | Typické rozhodnutí |
|---|---|---|
| **Schůze věřitelů** | všichni přihlášení věřitelé | strategická rozhodnutí (způsob řešení, RP, ustanovení výboru, odvolání správce) |
| **Věřitelský výbor** | volený sbor (3—7 členů) | průběžný dohled, schvalování průběžných úkonů správce |
| **Zástupce věřitelů** | u malých řízení (1 osoba) | suplement výboru |

Díl 5 doplňuje Hlavu II o dva specifické procesní subjekty — **státní zastupitelství** (vstupuje do řízení ve veřejném zájmu) a **likvidátor dlužníka** (zachovaný orgán PO v likvidaci).
