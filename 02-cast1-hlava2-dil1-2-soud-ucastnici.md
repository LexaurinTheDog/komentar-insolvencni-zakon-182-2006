...
## Díl 1 — Procesní subjekty (§ 9 — § 13) a Díl 2 — Účastníci řízení (§ 14 — § 20)

Hlava II vymezuje **kdo se účastní insolvenčního řízení** — koho zákon označuje jako „procesní subjekt", kdo má postavení účastníka řízení, jaký je vztah mezi pojmy „procesní subjekt" a „účastník řízení", co může a co nemůže insolvenční soud a jak se mění věřitel v případě převodu pohledávky.

Hlava obsahuje pět dílů:
- **Díl 1** (§ 9 — § 13): obecný výčet procesních subjektů + insolvenční soud,
- **Díl 2** (§ 14 — § 20): účastníci řízení (incidenční i hlavní),
- **Díl 3** (§ 21 — § 45): insolvenční správce *(samostatný soubor 03-...)*,
- **Díl 4** (§ 46 — § 68): věřitelské orgány — schůze věřitelů, věřitelský výbor *(samostatný soubor 04-...)*,
- **Díl 5** (§ 69 — § 70): státní zastupitelství *(součást souboru 04-...)*.

V této kapitole jde o **základní účastnickou strukturu**, která je rámcem celé další procesní úpravy. Pochopení rozdílu mezi pojmem „procesní subjekt" (§ 9 — širší kategorie) a „účastník řízení" (§ 14 — užší kategorie) je nezbytné pro správné čtení dalších paragrafů (např. doručování — § 75, opravné prostředky — § 84, hlasování věřitelů — § 49).
