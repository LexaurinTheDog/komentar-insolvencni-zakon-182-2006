...
**Majetková podstata** je *funkční pojem* — souhrn majetku **určeného k uspokojení věřitelů**. Není to samostatný subjekt práva (nemá právní osobnost) — *je to pouze vymezený majetkový agregát*, který se v rámci řízení spravuje, oceňuje, dispozičně omezuje, případně zpeněžuje.

Hlava VI upravuje:
- **Pojem a obsah** (§ 205 — § 208) — co do podstaty patří, co je vyloučeno.
- **Zjišťování** (§ 209 — § 216) — povinnosti správce, součinnost dlužníka, prohlášení o majetku, prohlídka.
- **Soupis** (§ 217 — § 224) — sestavení listiny, oceňování, vyrozumění třetích osob.
- **Vyloučení a vynětí** (§ 225 — § 227) — žaloby a návrhy na vyloučení věci.
- **Nakládání a správa** (§ 228 — § 230) — kdo a jak nakládá; pokyny zajištěných věřitelů.

Pochopení Hlavy VI je **kritické** pro praxi — určuje, *co* správce zpeněží a *jak hodnotné* tedy podstata bude. Spory o vyloučení věci (§ 225) jsou jedny z nejčastějších incidenčních sporů.

---

# Pojem a obsah majetkové podstaty (§ 205 — § 208)
